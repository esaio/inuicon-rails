...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{Icon web font with ligature (used in pplog.net) https://taea.github.io/inuicon/demo.html}
  gem.summary       = %q{Icon web font with ligature (used in pplog.net) https://taea.github.io/inuicon/demo.html}
